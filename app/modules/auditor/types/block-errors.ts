...
export type BlockError = StateSizeError | StateRootError | TransactionsRootError |
  HardTransactionsCountError | HardTransactionsRangeError | TransactionsLengthError;